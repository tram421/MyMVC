<form action="/admin/mail/send" method = 'POST'>
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline table-responsive" role="grid"
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                    colspan="1" aria-sort="ascending"
                                    aria-label="Rendering engine: activate to sort column descending" style="width:30px">Chọn</th>
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                    colspan="1" aria-sort="ascending"
    ...
    <div class="container">
        <div class="row"> 
            <div class="m-2">
                <label for="">Lý do gửi thư (subject)</label>
                <input type="text" name ='reasonSend'>
                
            </div>
            
            <!-- Nội dung mail -->
            <?php include __VIEW__.'/admin/mail/mail.php' ?>               
            <label for="">chủ đề chính: </label>                
            <!-- <input type="text" value="" name="mainSubject"> -->
        </div>
    </div>
    <button type='submit' class="float-right m-5 btn btn-success p-3">Gửi</button>
</form>
